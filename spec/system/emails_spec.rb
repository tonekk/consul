...
describe "Emails" do
  ...
  context "Proposal comments" do
    ...
    scenario "Send email on proposal comment" do
      ...
      expect(email).to have_body_text(edit_subscriptions_path(
                                        subscriptions_token: proposal.author.subscriptions_token))
    end
  ...
  context "Debate comments" do
    ...
    scenario "Send email on debate comment" do
      ...
      expect(email).to have_body_text("To stop receiving these emails change your settings in")
      expect(email).to have_body_text(edit_subscriptions_path(
                                        subscriptions_token: debate.author.subscriptions_token))
    end
  ...
  context "Budget investments comments" do
    ...
    scenario "Send email on budget investment comment" do
      ...
      expect(email).to have_body_text("To stop receiving these emails change your settings in")
      expect(email).to have_body_text(edit_subscriptions_path(
                                        subscriptions_token: investment.author.subscriptions_token))
    end
  ...
  context "Topic comments" do
    ...
    scenario "Send email on topic comment" do
      ...
      expect(email).to have_body_text("To stop receiving these emails change your settings in")
      expect(email).to have_body_text(edit_subscriptions_path(
                                        subscriptions_token: topic.author.subscriptions_token))
    end
  ...
  context "Poll comments" do
    ...
    scenario "Send email on poll comment" do
      ...
      expect(email).to have_body_text("To stop receiving these emails change your settings in")
      expect(email).to have_body_text(edit_subscriptions_path(
                                        subscriptions_token: poll.author.subscriptions_token))
    end
  ...
  context "Comment replies" do
    ...
    scenario "Send email on comment reply" do
      ...
      expect(email).to have_body_text("To stop receiving these emails change your settings in")
      expect(email).to have_body_text(edit_subscriptions_path(subscriptions_token: user.subscriptions_token))
    end
  ...
  context "Direct Message" do
    scenario "Receiver email" do
      ...
      expect(email).to have_body_text(edit_subscriptions_path(
                                        subscriptions_token: receiver.subscriptions_token))
    end
  ...
  context "Polls" do
    scenario "Send email on poll comment reply" do
      ...
      expect(email).to have_body_text(comment_path(Comment.last))
      expect(email).to have_body_text("To stop receiving these emails change your settings in")
      expect(email).to have_body_text(edit_subscriptions_path(subscriptions_token: user1.subscriptions_token))
    end
  end
    ...
    scenario "Send newsletter email to selected users" do
      ...
      expect(email).to have_body_text(
                        edit_subscriptions_path(
                          subscriptions_token: user_with_newsletter_in_segment_2.subscriptions_token))
    end
  end
