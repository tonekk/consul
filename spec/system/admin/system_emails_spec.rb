...
describe "System Emails" do
  ...
  context "View" do
    ...
    scenario "#comment" do
      ...
      expect(page).to have_link("Unsubscribe",
                                href: edit_subscriptions_url(subscriptions_token: user.subscriptions_token,
                                                             host: app_host))
    end
    ...
    scenario "#direct_message_for_receiver" do
      ...
      expect(page).to have_link("Unsubscribe",
                                href: edit_subscriptions_url(subscriptions_token: admin.user.subscriptions_token,
                                                             host: app_host))
    end
